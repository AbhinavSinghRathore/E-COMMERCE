...
<form action="password-change" method="post">
   <div class="container col-4" style="border:1px solid grey;border-radius: 14px;padding:41px;">
      <div class="row">
          <h4  class="col-12">Password assistance</h4>
			<span class="text-danger">${Message}</span>          
      </div>
      
    <div class="row">
       
          <label class="form-group"> Enter the email:</label>
          
          <input class="form-control" style="padding:10px; height:35px;" type="text" name="email" required/>
